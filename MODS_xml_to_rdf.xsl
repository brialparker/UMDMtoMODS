...
-->
<xsl:if test=" mods:abstract or mods:accessCondition or mods:tableOfContents or mods:targetAudience">
<xsl:value-of select="$newline"/>
<xsl:comment>
************************* simple elements *************************
</xsl:comment>
...
-->
<xsl:if test=" mods:classification or mods:language or mods:location or mods:originInfo or mods:note or mods:part or mods:physicalDescription">
<xsl:value-of select="$newline"/>
<xsl:comment>
************************* other elements *************************
</xsl:comment>
...
<xsl:comment>*******classification</xsl:comment>
...
<xsl:choose>
<xsl:when test=" @usage or ( (mods:role[mods:roleTerm='creator'] or mods:role[mods:roleTerm='cre'] ) and count( /mods:mods/mods:name/mods:role[mods:roleTerm='creator'] or /mods:mods/mods:name/mods:role[mods:roleTerm='cre'] )=1 and not(/mods:mods/mods:name/@usage) )">
...
<xsl:value-of select="$newline"/>
<xsl:comment>**** Roles for this name.</xsl:comment>
<xsl:value-of select="$newline"/>
</xsl:if>
<!--
...
<xsl:otherwise>
<xsl:value-of select="concat( mods:namePart[@type='termsOfAddress'], $space, mods:namePart[@type='given'], $space, mods:namePart[@type='family'], $space, mods:namePart[@type='date'], $space)"/>
</xsl:otherwise>
</xsl:choose>
</xsl:template>
<!--
...
statement of responsibility
 -->
<xsl:comment>*******statement of responsibility</xsl:comment>
<xsl:value-of select="$newline"/>
...
Note  - no type
 -->
<xsl:comment>*******note - no type</xsl:comment>
<xsl:value-of select="$newline"/>
<modsrdf:note>
<xsl:value-of select="."/>
</modsrdf:note>
...
type other than statementOfResponsibility
 -->
<xsl:comment>*******typed note</xsl:comment>
<xsl:value-of select="$newline"/>
<modsrdf:noteGroup>
<modsrdf:NoteGroup>
...
<!--   
                                     place
                                               -->
<xsl:comment>*******place of origin</xsl:comment>
<xsl:value-of select="$newline"/>
...
<xsl:comment>******* note - Physical Description</xsl:comment>
<modsrdf:noteGroup>
<modsrdf:NoteGroup>
<modsrdf:noteGroupType>
...
-->
<xsl:when test="(/mods:mods/mods:name/@usage) or ((/mods:mods/mods:name/mods:role[mods:roleTerm='creator']) or (/mods:mods/mods:name/mods:role[mods:roleTerm='cre']) and (count( /mods:mods/mods:name/mods:role[mods:roleTerm='creator'] or /mods:mods/mods:name/mods:role[mods:roleTerm='cre']) = 1)) ">
...
<xsl:comment>******* Principal Title</xsl:comment>
<!--   -->
...
<xsl:for-each select="/mods:mods/mods:name">
<xsl:if test="@usage or (mods:role[mods:roleTerm='creator'] and count(/mods:mods/mods:name/mods:role[mods:roleTerm='creator'])=1 and not(/mods:mods/mods:name/@usage))">
...
<xsl:element name="rdf:type">
<xsl:attribute name="rdf:resource">
<xsl:value-of select="concat($resourceTypeURI,'Collection')"/>
</xsl:attribute>
</xsl:element>
</xsl:if>
<!--   -->
...
<xsl:element name="rdf:type">
<xsl:attribute name="rdf:resource">
<xsl:value-of select="concat($resourceTypeURI,'Manuscript')"/>
</xsl:attribute>
</xsl:element>
</xsl:if>
<xsl:value-of select="$newline"/>
